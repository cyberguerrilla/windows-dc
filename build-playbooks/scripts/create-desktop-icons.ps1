...
$TargetFile = "C:\Windows\System32\dsa.msc"
$ShortcutFile = "$env:Public\Desktop\ActiveDirectory.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$Shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$Shortcut.TargetPath = $TargetFile
$Shortcut.Save()
...
#AD Users and Computers shortcut
$TargetFile = "C:\Windows\System32\gpmc.msc"
$ShortcutFile = "$env:Public\Desktop\GroupPolicy.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$Shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$Shortcut.TargetPath = $TargetFile
$Shortcut.Save()
...
#AD Users and Computers shortcut
$TargetFile = "C:\Windows\System32\dnsmgmt.msc"
$ShortcutFile = "$env:Public\Desktop\DNS.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$Shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$Shortcut.TargetPath = $TargetFile
$Shortcut.Save()
...
#Scripts shortcuts
$TargetFile = "C:\temp\scripts"
$ShortcutFile = "$env:Public\Desktop\Scripts.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$Shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$Shortcut.TargetPath = $TargetFile
$Shortcut.Save()
...
#Winlogbeat shortcut
$TargetFile = "C:\ProgramData\chocolatey\lib\winlogbeat\tools"
$ShortcutFile = "$env:Public\Desktop\winlogbeat.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$Shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$Shortcut.TargetPath = $TargetFile
$Shortcut.Save()
